...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/ZenithLoom/context` | Codebase overview, check index freshness |
| `gitnexus://repo/ZenithLoom/clusters` | All functional areas |
| `gitnexus://repo/ZenithLoom/processes` | All execution flows |
| `gitnexus://repo/ZenithLoom/process/{name}` | Step-by-step execution trace |
