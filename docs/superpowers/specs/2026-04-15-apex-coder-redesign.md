...
| `blueprints/functional_graphs/apex_coder/entity.json` | 添加 `inherit_from` 到 QA 和 Coder 节点 |
| `blueprints/functional_graphs/apex_coder/validators.py` | setup 加 inherit 增强（读 refined_plan、清 session keys） |
...
| 文件 | 职责 |
|------|------|
| `blueprints/functional_graphs/apex_coder/entity.json` | 7 节点图定义 |
| `blueprints/functional_graphs/apex_coder/state.py` | ApexCoderState schema |
| `blueprints/functional_graphs/apex_coder/validators.py` | setup, reset_for_coder, executor, route, inject_error_context |
| `blueprints/functional_graphs/apex_coder/CODER_ROLE.md` | Coder persona |
| `blueprints/functional_graphs/apex_coder/QA_ROLE.md` | QA persona |
| `blueprints/functional_graphs/apex_coder/PROTOCOL.md` | 共享工程实践 |
| `blueprints/functional_graphs/apex_coder/hooks/protect_qa_tests.py` | PreToolUse 防作弊 hook |
